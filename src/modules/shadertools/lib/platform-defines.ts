...
export function getPlatformShaderDefines(gl: WebGL2RenderingContext | WebGLRenderingContext) {
...
export function getVersionDefines(gl: WebGL2RenderingContext | WebGLRenderingContext, glslVersion: any, isFragment: boolean) {
